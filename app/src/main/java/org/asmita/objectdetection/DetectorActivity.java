...
import org.asmita.objectdetection.tflite.DetectorFactory;
import org.asmita.objectdetection.tflite.YoloV5Classifier;
...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener
{
  ...
  private final String REGEX_OCR_TRIGGER_SPEECH = "what('s| is) written";
  ...
  protected void onCreate(Bundle savedInstanceState)
  {
    ...
    voiceRecognitionButton = findViewById(R.id.voice_recognition_button);
    voiceRecognitionButton.setOnClickListener(new View.OnClickListener() {
      @Override
      public void onClick(View v) {
        // Call the method to start voice recognition
...
//    String centreSentence = formSentencecentre(objectsInFront);
  ...
  {
    String objectsInFront = detectedText;
